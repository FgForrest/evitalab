 ...
 * used to target and left the console side tabs (the only ones without a slider) with no indication
 * of the active view at all. This asserts the two sides still agree.
 */
