 ...
 *
 * @generated from message io.evitadb.externalApi.grpc.generated.GrpcExportTrafficRecordingRequest
 */
...
/**
 * Describes the message io.evitadb.externalApi.grpc.generated.GrpcExportTrafficRecordingRequest.
 * Use `create(GrpcExportTrafficRecordingRequestSchema)` to create a new message.
 */
export const GrpcExportTrafficRecordingRequestSchema: GenMessage<GrpcExportTrafficRecordingRequest> = /*@__PURE__*/
...
export const GrpcEvitaTrafficRecordingService: GenService<{
   ...
   *
   * @generated from rpc io.evitadb.externalApi.grpc.generated.GrpcEvitaTrafficRecordingService.ExportTrafficRecording
   */
  exportTrafficRecording: {
    methodKind: "unary";
    input: typeof GrpcExportTrafficRecordingRequestSchema;
    output: typeof GetTrafficRecordingStatusResponseSchema;
  },
}> = /*@__PURE__*/
