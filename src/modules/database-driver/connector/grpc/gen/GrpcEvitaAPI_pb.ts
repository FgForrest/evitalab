 ...
 */
export class GrpcGetCatalogStateRequest extends Message<GrpcGetCatalogStateRequest> {
  /**
  ...
  constructor(data?: PartialMessage<GrpcGetCatalogStateRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "io.evitadb.externalApi.grpc.generated.GrpcGetCatalogStateRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "catalogName", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GrpcGetCatalogStateRequest {
    return new GrpcGetCatalogStateRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GrpcGetCatalogStateRequest {
    return new GrpcGetCatalogStateRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GrpcGetCatalogStateRequest {
    return new GrpcGetCatalogStateRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GrpcGetCatalogStateRequest | PlainMessage<GrpcGetCatalogStateRequest> | undefined, b: GrpcGetCatalogStateRequest | PlainMessage<GrpcGetCatalogStateRequest> | undefined): boolean {
    return proto3.util.equals(GrpcGetCatalogStateRequest, a, b);
  }
}
 ...
 */
export class GrpcGetCatalogStateResponse extends Message<GrpcGetCatalogStateResponse> {
  /**
  ...
  constructor(data?: PartialMessage<GrpcGetCatalogStateResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "io.evitadb.externalApi.grpc.generated.GrpcGetCatalogStateResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "catalogState", kind: "enum", T: proto3.getEnumType(GrpcCatalogState), opt: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GrpcGetCatalogStateResponse {
    return new GrpcGetCatalogStateResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GrpcGetCatalogStateResponse {
    return new GrpcGetCatalogStateResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GrpcGetCatalogStateResponse {
    return new GrpcGetCatalogStateResponse().fromJsonString(jsonString, options);
  }

  static equals(a: GrpcGetCatalogStateResponse | PlainMessage<GrpcGetCatalogStateResponse> | undefined, b: GrpcGetCatalogStateResponse | PlainMessage<GrpcGetCatalogStateResponse> | undefined): boolean {
    return proto3.util.equals(GrpcGetCatalogStateResponse, a, b);
  }
}
