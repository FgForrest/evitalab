...
export const EvitaSessionService = {
  ...
  methods: {
     ...
     */
    closeWithProgress: {
      name: "CloseWithProgress",
      I: Empty,
      O: GrpcCloseWithProgressResponse,
      kind: MethodKind.ServerStreaming,
    },
    /**
