...
proto3.util.setEnumType(GrpcStatisticsBase, "io.evitadb.externalApi.grpc.generated.GrpcStatisticsBase", [
  ...
  { no: 2, name: "COMPLETE_FILTER_EXCLUDING_SELF_IN_USER_FILTER" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(GrpcFacetRelationType)
proto3.util.setEnumType(GrpcFacetRelationType, "io.evitadb.externalApi.grpc.generated.GrpcFacetRelationType", [
  { no: 0, name: "DISJUNCTION" },
  { no: 1, name: "CONJUNCTION" },
  { no: 2, name: "NEGATION" },
  { no: 3, name: "EXCLUSIVITY" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(GrpcFacetGroupRelationLevel)
proto3.util.setEnumType(GrpcFacetGroupRelationLevel, "io.evitadb.externalApi.grpc.generated.GrpcFacetGroupRelationLevel", [
  { no: 0, name: "WITH_DIFFERENT_FACETS_IN_GROUP" },
  { no: 1, name: "WITH_DIFFERENT_GROUPS" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(GrpcTraversalMode)
proto3.util.setEnumType(GrpcTraversalMode, "io.evitadb.externalApi.grpc.generated.GrpcTraversalMode", [
