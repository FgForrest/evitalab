...
import { GrpcAttributeSpecialValue, GrpcEmptyHierarchicalEntityBehaviour, GrpcEntityScope, GrpcFacetGroupRelationLevel, GrpcFacetRelationType, GrpcFacetStatisticsDepth, GrpcHistogramBehavior, GrpcManagedReferencesBehaviour, GrpcOrderDirection, GrpcPriceContentMode, GrpcQueryPriceMode, GrpcStatisticsBase, GrpcStatisticsType, GrpcTraversalMode } from "./GrpcEnums_pb.js";
...
export class GrpcQueryParam extends Message<GrpcQueryParam> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 25, name: "facetRelationType", kind: "enum", T: proto3.getEnumType(GrpcFacetRelationType), oneof: "queryParam" },
    { no: 26, name: "facetGroupRelationLevel", kind: "enum", T: proto3.getEnumType(GrpcFacetGroupRelationLevel), oneof: "queryParam" },
    { no: 27, name: "traversalMode", kind: "enum", T: proto3.getEnumType(GrpcTraversalMode), oneof: "queryParam" },
