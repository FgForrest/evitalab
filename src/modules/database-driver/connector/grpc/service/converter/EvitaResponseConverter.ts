...
import { grpcMessageToJson } from '@/utils/JsonUtil.ts'
import { GrpcQueryResponseSchema } from '@/modules/database-driver/connector/grpc/gen/GrpcEvitaSessionAPI_pb'
...
export class EvitaResponseConverter {
    ...
    convert(grpcResponse: GrpcQueryResponse) : EvitaResponse {
        return new EvitaResponse(
            ...
            JSON.stringify(grpcMessageToJson(GrpcQueryResponseSchema, grpcResponse))
        )
    }
