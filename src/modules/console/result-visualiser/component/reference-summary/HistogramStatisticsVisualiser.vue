...
<template>
    <VExpansionPanels>
        <VExpansionPanel v-for="histStats in histograms" :key="histStats.indexName">
            <VExpansionPanelTitle>
                <VIcon class="mr-4">mdi-chart-bar</VIcon>
                {{ histStats.indexName }}
            </VExpansionPanelTitle>
            <VExpansionPanelText>
                <HistogramVisualiser :histogram="histStats.histogram" />
            </VExpansionPanelText>
        </VExpansionPanel>
    </VExpansionPanels>
</template>
